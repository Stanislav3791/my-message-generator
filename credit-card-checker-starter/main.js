...
let step1 = array.slice();
let popped = step1.pop();
let reversed = step1.reverse();
...
let prefinal = odd.concat(even);
let sum = 0; 
for (let k = 0; k < prefinal.length; k++) {
  sum += prefinal[k]; 
  };
  sum += popped;
/*  
